...
HD_PWD='C:/Users/escar/OneDrive/Documentos/GitHub/TFG/Vivado/microSD_controller/microSD_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SdCardCtrlTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SdCardCtrlTest.tcl
