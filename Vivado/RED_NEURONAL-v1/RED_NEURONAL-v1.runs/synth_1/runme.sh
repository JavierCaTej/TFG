...
HD_PWD='C:/Users/escar/OneDrive/Documentos/GitHub/TFG/Vivado/RED_NEURONAL-v1/RED_NEURONAL-v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log red_neuronal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source red_neuronal.tcl
