...
HD_PWD='C:/Users/escar/OneDrive/Documentos/GitHub/TFG/Vivado/imageProcessingTutorial/imageProcessingTutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcessTop.tcl
